...
const AudioElement = ({ currentTrack, nextTrack, elapsed, isPlaying, togglePlay }) => (
  <div class="row">
    ...
    <div class="track-controls col-lg-4 text-xs-center">
      <span class="text-muted mr-1">{ `${moment.duration(elapsed, 'seconds').format('h:mm:ss', { forceLength: true, trim: false })} / ${'object' === typeof currentTrack ? moment.duration(currentTrack.length, 'seconds').format('h:mm:ss', { trim: false }) : '0:00'}`}</span>
